...
-(DWFlashFlowProcessorBlock)reprocessorFromRequest:(DWFlashFlowRequest *)r {
    if (!r) {
        return nil;
    }
...
static DWFlashFlowProcessorBlock blockFromTwo(DWFlashFlowProcessorBlock a,DWFlashFlowProcessorBlock b) {
    int c = 0;
    if (a) {
        c++;
    }
