...
@property (nonatomic ,copy) DWFlashFlowProcessorBlock reprocessingAfterResponse;
...
///实际请求的预处理回调
@property (nonatomic ,copy) DWFlashFlowProcessorBlock actualPreprocessing;

//Actual request reprocessor
///实际请求的二次处理回调
@property (nonatomic ,copy) DWFlashFlowProcessorBlock actualReprocessor;
